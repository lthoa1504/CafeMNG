...
Public Class ViewOrders
    ...
    Private Sub OrdersDGV_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles OrdersDGV.CellContentClick
